...
import { ISimpleFarcasterUser, ISimpleCodeModel, IHasProgram, IHasCreator, IHasVisibilityStats } from '../models';
...
export const useProfileStore = defineStore('profile', () => {
    ...
    const profileCodes = ref<(ISimpleCodeModel & IHasCreator & IHasProgram & IHasVisibilityStats)[]>([]);
