import { FeedType, IHasCreator, IHasProgram,  ISimpleCodeModel, ISimpleFarcasterUser, ISimpleProgram } from '../models';
import { DUMMY_CODES, DUMMY_PROGRAM, DUMMY_TRENDING_PROGRAMS, DUMMY_USER } from '../models/dummy';
import { SupabaseClient, createClient } from '@supabase/supabase-js'
import { Database, IView, IUserProfile, IProgram, IViewReferralProgram } from './models';
...
export const createCli = (jwt: Jwt): ICli => {
    ...
    return { client: createClient<Database>(supabaseUrl, supabaseAnonKey, {
